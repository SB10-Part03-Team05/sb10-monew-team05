...
CREATE INDEX IF NOT EXISTS idx_articles_active_publish_date ON articles (publish_date DESC) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_notifications_unread ON notifications (user_id, created_at DESC) WHERE confirmed_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_notifications_comment_id ON notifications (comment_id) WHERE comment_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_notifications_interest_id ON notifications (interest_id) WHERE interest_id IS NOT NULL;
