...
class ArticleRepositoryTest {
  ...
  void findDistinctSource() {
    // given(준비)
    createArticle(ArticleSource.NAVER, "https://naver1.com", "title1",
        Instant.now(), "summary1");
    createArticle(ArticleSource.NAVER, "https://naver2.com", "title2",
        Instant.now(), "summary2");
    createArticle(ArticleSource.CHOSUN, "https://chosun1.com", "title3",
